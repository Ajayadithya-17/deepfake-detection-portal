"""
=============================================================================
Deepfake Detection System - Face Detection & Alignment Module
=============================================================================
...
fallback to OpenCV Haar Cascade and aspect-ratio-preserving square center-cropping.
=============================================================================
"""
    ...
    if detector is not None:
        try:
            ...
            if detections and len(detections) > 0:
                ...
                if best_det.get('confidence', 0) > 0.80:
